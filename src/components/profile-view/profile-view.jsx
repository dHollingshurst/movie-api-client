...
export class ProfileView extends React.Component {
    ...
    onRemoveFavorite = (e, movie) => {
        ...
        axios
            .delete(
                `https://davemoviebase.herokuapp.com/users/${Username}/movies/${movie._id}`,
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                `https://davemoviebase.herokuapp.com/users/${Username}`,
                {
    ...
    onDeleteUser() {
        ...
        axios
            .delete(`https://davemoviebase.herokuapp.com/users/${Username}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
